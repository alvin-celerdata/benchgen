...
class CustomerDemographicsGenerator final : public RecordBatchIterator {
 public:
  explicit CustomerDemographicsGenerator(GeneratorOptions options);
  ~CustomerDemographicsGenerator() override;
