...
class CustomerAddressGenerator final : public RecordBatchIterator {
 public:
  explicit CustomerAddressGenerator(GeneratorOptions options);
  ~CustomerAddressGenerator() override;
