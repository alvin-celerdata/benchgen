...
class WebSiteRowGenerator {
 public:
  WebSiteRowGenerator(double scale);

  void SkipRows(int64_t start_row);
  WebSiteRowData GenerateRow(int64_t row_number);
