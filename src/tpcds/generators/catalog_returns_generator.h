...
class CatalogReturnsGenerator final : public RecordBatchIterator {
 public:
  explicit CatalogReturnsGenerator(GeneratorOptions options);
  ~CatalogReturnsGenerator() override;
