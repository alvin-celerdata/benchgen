...
class HouseholdDemographicsGenerator final : public RecordBatchIterator {
 public:
  explicit HouseholdDemographicsGenerator(GeneratorOptions options);
  ~HouseholdDemographicsGenerator() override;
